...
lapply(c('ggplot2','ggpubr','tidyverse', 'dplyr',
         'lubridate', 'rphylopic', 'ggbreak', 'parallel'), library, character.only=TRUE)
...
Ind_Z <- subset(read.csv('FINAL_ALL_INDIVIDUALS.csv', header=T, sep=','), Species =="Zebra")
...
### WILDEBEEST
Num_demo_W <- subset(read.csv('Nmonth_All_FINAL.csv'), Species == "Wildebeest")
...
Ind_W <- subset(read.csv('FINAL_ALL_INDIVIDUALS.csv', header=T, sep=','), Species =="Wildebeest")
            ...
            repeat{
              ...
              if(Ngraze == 0 ){ 
                ...
                for( i in (1:length(ngram))){
                  if(runif(1) > Prop[s]){  ## This is to give the proportion of individuals eating grass only or grass+soil
...
write.csv(Zebra_DryPathogen_WetVisits_Final,'Final_data/Zebra__Dry_Pathogen_Wet_visit_100.csv', row.names = F)
...
write.csv(Zebra_WetPathogen_WetVisits_Final,'Final_data/Zebra__Wet_Pathogen_Wet_visit_100.csv', row.names = F)
...
write.csv(Zebra_WetPathogen_DryVisits_Final,'Final_data/Zebra__Wet_Pathogen_Dry_visit_100.csv', row.names = F)
...
write.csv(Zebra_DryPathogen_DryVisits_Final,'Final_data/Zebra__Dry_Pathogen_Dry_visit_100.csv', row.names = F)
...
write.csv(Wildebeest_DryPathogen_WetVisits_Final,'Final_data/Wildebeest__Dry_Pathogen_Wet_visit_100.csv', row.names = F)
...
write.csv(Wildebeest_WetPathogen_WetVisits_Final,'Final_data/Wildebeest__Wet_Pathogen_Wet_visit_100.csv', row.names = F)
...
write.csv(Wildebeest_WetPathogen_DryVisits_Final,'Final_data/Wildebeest__Wet_Pathogen_Dry_visit_100.csv', row.names = F)
...
write.csv(Wildebeest_DryPathogen_DryVisits_Final,'Final_data/Wildebeest__Dry_Pathogen_Dry_visit_100.csv', row.names = F)
...
write.csv(Wildebeest_All_Final,'Final_data/Wildebeest__All_100.csv', row.names = F)
...
write.csv(Zebra_All_Final,'Final_data/Zebra__All_100.csv', row.names = F)
